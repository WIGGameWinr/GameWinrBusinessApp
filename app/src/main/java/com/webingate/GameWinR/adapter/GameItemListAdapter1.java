 ...
 */
public class GameItemListAdapter1 extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public GameItemListAdapter1(ArrayList<GameResponce> placeArrayList) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if (viewHolder instanceof PlaceViewHolder) {
            ...
            holder.gametype1.setText(gamelist.getTypeName());
            holder.gametimelist.setText(gamelist.getDate()+""+gamelist.getTime());
...
//                Utils.setImageToImageView(context, holder.gameimage, id);            }
    ...
    public class PlaceViewHolder extends RecyclerView.ViewHolder {
        ImageView gameimage;
        TextView gametitlename,gametimelist,gametype1;
