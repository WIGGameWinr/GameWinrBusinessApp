 ...
 */
public class PriceItemListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public PriceItemListAdapter(List<ShopItem> shopItemList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.price_list__activity_item, parent, false);
