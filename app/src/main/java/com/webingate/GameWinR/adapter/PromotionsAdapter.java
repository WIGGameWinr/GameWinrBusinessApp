...
public class PromotionsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, PromotionsVO promotion, int position);
    }
    ...
    public PromotionsAdapter(List<PromotionsVO> promotionsList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == 0) {
            View prmotionsView = LayoutInflater.from(parent.getContext()).inflate(R.layout.promotionsfirstitem, parent, false);
            return new PromotionsViewHolder(prmotionsView);
        }

        View prmotionsView = LayoutInflater.from(parent.getContext()).inflate(R.layout.promotionsitem, parent, false);
        return new PromotionsViewHolder(prmotionsView);
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof PromotionsViewHolder) {
            ...
            if (position == 0) {
                ...
                int promotionsImageId = R.drawable.game1;
                ...
                PromotionsVO PromotionsVO = promotionsList.get(position);
                PromotionsViewHolder promotionsViewHolder = (PromotionsViewHolder) holder;
                Context context = promotionsViewHolder.promotionsImageView.getContext();
