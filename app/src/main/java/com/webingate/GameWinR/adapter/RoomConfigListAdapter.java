 ...
 */
public class RoomConfigListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public RoomConfigListAdapter(ArrayList<GameResponce> placeArrayList) {
