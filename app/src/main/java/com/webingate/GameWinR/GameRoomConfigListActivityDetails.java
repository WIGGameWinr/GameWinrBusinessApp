...
public class GameRoomConfigListActivityDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.game_room_list_details);
        initData();
        initUI();
        initDataBindings();
        initActions();
    ...
    private void initToolbar() {
        ...
        toolbar.setTitle("Game Room Details");
