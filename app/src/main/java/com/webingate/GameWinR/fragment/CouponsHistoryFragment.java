...
public class CouponsHistoryFragment extends Fragment {
...
//    private ImageView copyImageView3;
    ...
    public CouponsHistoryFragment(String status) {
        // Required empty public constructor
        this.status = status;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.coupons_history_fragment, container, false);
        initUI(view);
        initActions();
        return view;
    }
