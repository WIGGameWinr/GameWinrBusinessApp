...
/**
 * Created by lampex on 8/16/2017.
 */
...
public class ApplicationConstants {
    ...
    public static String sourcelatitude="0.00";
    ...
    public static List documentslist;
    public static ArrayList bookingList;
    public static int documentNo=0;
